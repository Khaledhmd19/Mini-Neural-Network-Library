...
Created by Hamoud as an educational neural network implementation.

---

**Note**: This is a learning project. For production use cases, consider using established libraries like PyTorch or TensorFlow.
